...
@interface ExpandTest ()<UITableViewDataSource,UITableViewDelegate>
...
- (void)addSubView
{
    self.mTabelView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0,SCREEN_WIDTH,SCREEN_HEIGHT) style:UITableViewStylePlain];
