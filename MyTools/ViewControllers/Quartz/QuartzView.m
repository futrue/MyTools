...
- (void)drawRect:(CGRect)rect {
    ...
    CGPathMoveToPoint(path, nil, 50, 80);// 顶点
    CGPathMoveToPoint(path, nil, 50, 180);// 第一个连接点
    // ....
    CGPathMoveToPoint(path, nil, 150, 180);// 顶点
    // 添加路劲
    ...
    /*设置阴影
     ...
     color:阴影颜色
     */
    CGColorRef color = [UIColor redColor].CGColor;//颜色转化，由于Quartz 2D跨平台，所以其中不能使用UIKit中的对象，但是UIkit提供了转化方法
