...
@interface LHWaveProgressView ()

@property (nonatomic, weak,readwrite) UIImageView *backgroundImageView;

@property (nonatomic, weak) LHWaterWaveView *waterWaveView;
...
@end
@implementation LHWaveProgressView
...
{
    LHWaterWaveView *waterWaveView = [[LHWaterWaveView alloc]init];
