...
- (void)drawRect:(CGRect)rect {
    ...
    /*写文字*/
//    CGContextSetRGBFillColor (context,  1, 0, 0, 1.0);//设置填充颜色//在drawInRect：withFont：有作用
    // 在drawInRect：withAttributes中就需要NSForegroundColorAttributeName
    UIFont  *font = [UIFont boldSystemFontOfSize:15.0];//设置
    NSDictionary *attribute = @{NSFontAttributeName:font,NSForegroundColorAttributeName:[UIColor redColor]};
    [@"画圆：" drawInRect:CGRectMake(10, 20, 80, 20) withAttributes:attribute];
    [@"画线及孤线：" drawInRect:CGRectMake(10, 80, 100, 20) withAttributes:attribute];
    [@"画矩形：" drawInRect:CGRectMake(10, 120, 80, 20) withAttributes:attribute];
    [@"画扇形和椭圆：" drawInRect:CGRectMake(10, 160, 110, 20) withAttributes:attribute];
    [@"画三角形：" drawInRect:CGRectMake(10, 220, 80, 20) withAttributes:attribute];
    [@"画圆角矩形：" drawInRect:CGRectMake(10, 260, 100, 20) withAttributes:attribute];
    [@"画贝塞尔曲线：" drawInRect:CGRectMake(10, 300, 100, 20) withAttributes:attribute];
    [@"图片：" drawInRect:CGRectMake(10, 340, 80, 20) withAttributes:attribute];
    ...
    /*图片*/
    UIImage *image = [UIImage imageNamed:@"share_platform_qqfriends"];
