...
@implementation CustomButton_test2
...
- (void)viewDidLoad {
    ...
    showLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 64,CGRectGetWidth(self.view.frame), 30)];
